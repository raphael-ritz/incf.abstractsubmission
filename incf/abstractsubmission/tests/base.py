...
def setup_product():
    ...
    import incf.abstractsubmission
    zcml.load_config('configure.zcml', incf.abstractsubmission)
    ...
    ztc.installPackage('incf.abstractsubmission')
...
setup_product()
ptc.setupPloneSite(products=['incf.abstractsubmission'])
